...
namespace Graphics
{
    class Renderer
    {
        ...
        public void Initialize()
        {
            ...
            building.LoadFile(projectPath + "\\ModelFiles\\static\\building", "Building 02.obj", 3);
            building.scalematrix = glm.scale(new mat4(1), new vec3(1, 1, 1));
            building.transmatrix = glm.translate(new mat4(1), new vec3(0, 2, 0));
            tree = new Model3D();
            tree.LoadFile(projectPath + "\\ModelFiles\\static\\tree", "Tree.obj", 4);
            tree.scalematrix = glm.scale(new mat4(1), new vec3(50f, 80f, 50f));
            tree.transmatrix = glm.translate(new mat4(1), new vec3(-800, 400, -700));
            tree2 = new Model3D();
            tree2.LoadFile(projectPath + "\\ModelFiles\\static\\Tree_02", "Tree.obj", 5);
            tree2.scalematrix = glm.scale(new mat4(1), new vec3(50 , 100, 50));
            tree2.transmatrix = glm.translate(new mat4(1), new vec3(-800,400,700));
            grass = new Model3D();
            ...
            palm = new Model3D();
            palm.LoadFile(projectPath + "\\\\ModelFiles\\static\\palm", "palm1.obj", 7);
           palm.scalematrix = glm.scale(new mat4(1), new vec3(20f,30f, 20f));
            palm.transmatrix = glm.translate(new mat4(1), new vec3(-500, 400  ,-500));
        ...
        public void Draw()
        {
           ...
           Gl.glDrawArrays(Gl.GL_TRIANGLES, 0, 6);
            ...
            //Gl.glDrawArrays(Gl.GL_TRIANGLES, 0, ver.Count);
            //g.draw(modelID);
            //a1.Bind();
            //my_g.draW(modelID);
